const projects = [
    {
        ...
        tags: ['React', 'SASS', 'Rapidapi', 'YouTube V3 API'],
        liveLink: 'https://vod.hossainsany.com/',
        githubLink: 'https://github.com/hossainsany/vod-yt',
        id: 1,
        img: './project-img/vod.jpg',
    },
    {
        title: 'WebExis Website',
        description:
            'This is a website for a web development and maketing agency. It was created using Next JS, and Tailwind CSS. This project showcases my skills in front-end development.',
        tags: ['Next Js', 'React', 'Tailwind CSS'],
        liveLink: 'https://webexis.net/',
        githubLink: 'https://github.com/hossainsany/webexis',
        id: 7,
        img: './project-img/webexis.jpg',
    },
    {
